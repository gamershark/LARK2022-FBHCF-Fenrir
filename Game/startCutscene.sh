...
# Day one
tput cuu1
printf "On the first day of the conference, "
sleep 1
printf "the attendees introduce themselves, and you prepare their rooms. "
sleep 1
printf "Though, of course, "
sleep 1
printf "instead of using their rooms for sleep, "
sleep 1
echo "they simply use time machines to go back to their own time."
sleep 1
echo ""
printf "On the first night though, "
sleep 1
echo "something terrible were to happen..."
echo ""
echo "Press any key to continue"
read -n 1
...
sleep
echo ""
echo "You leave your room and enter the lobby, to see a sight that horrors you."
sleep 1
printf "The deceased body of "; tput setaf 4; echo "Kay "; tput setaf 7; echo "with an onimous note placed on top of them."
sleep 1
echo ""
...
# PS1 variable thing
tput cuu1
printf "To help you with knowing when you are, "
sleep 1
printf "the attendees have given you a bracelet that displays when you are, "
sleep 1
echo "and what time (locally) of the conference it is."
sleep 1
